                        ...
                        using (MySqlCommand cmd = new MySqlCommand(procedimiento, conn))
                        {
                            ...
                            using (MySqlDataReader reader = cmd.ExecuteReader())
                            {
                                if (reader.Read()) // Si se encuentra un registro
                                {
                                    ...
                                    mon.NoInventario = reader.GetString("No_Inventario");
                ...
                using (Conexion cn = new Conexion())
                {
                    using (MySqlConnection conn = cn.GetConnection())
                    {
                        ...
                        using (MySqlCommand cmd = new MySqlCommand(procedimiento, conn))
                        {
                            ...
                            {
                                resultadoMensaje = $"No se encontró el monitor con número de inventario '{modelo.NoInventario}' para actualizar o no hubo cambios.";
                            }
                        } // cmd se dispone aquí.
                    } // conn se cierra y dispone aquí.
                } // cn se dispone aquí.
